 ...
 */
Ext.define('Ext.ux.monthfield.MonthField',{
    ...
    ,initComponent : function()
    {
        var me = this;
        me.callParent();
        this.blankText = 'Obrigat&oacute;rio';
        this.minText = 'O valor m&iacute;nimo para este campo &eacute; {0}';
        this.invalidText = '{0} n&atilde;o &eacute; um formato v&aacute;lido, o format esperado &eacute; {1}. Utilize o &iacute;cone ao lado para selecionar uma data';
    }
